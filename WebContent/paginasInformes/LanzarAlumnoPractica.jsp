...
%>
	...
	function redirigir(idUser) {
		...
		window.location="LanzarAlumnoPractica.jsp?user="+idUser+"&list=" + valores + "&practica=" + idPrac;
 	}
	</script>
<%
	// Ruta
			...
			<li>
				...
				<ul><%
					...
					for (String test:ListaTest){%>
						<li><a href="<%=Configuracion.Jsp_AlumnosT%>?user=<%=idUsuario%>&list=<%=idAlumnos%>&practica=<%=id_practica%>&test=<%out.println(test);%>">
