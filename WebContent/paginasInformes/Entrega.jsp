...
<script type="text/javascript">
	...
	function BorrarDatosAlumnos() {
		...
		if (confirmacion == true) {
				...
				window.location="Entrega.jsp?user=" + idUser + "&list" + valores + "&boolean=borrarAlumnos";
		}else{
	...
	function BorrarDatosPracticas() {
		...
		if (confirmacion == true) {
				alert("Hecho. Se han borrado los datos de los alumnos");
				window.location="Entrega.jsp?user=" + idUser + "&list" + valores + "&boolean=borrarPracticas";
		}else{
			alert("La operación se ha cancelado a petición del usuario");
			window.location="Entrega.jsp?user=" + idUser + "&list" + valores;
		}	
	...
	function BorrarDatosEstadisticas() {
		...
		if (confirmacion == true) {
			alert("Hecho. Se han borrado los datos de los alumnos");
			window.location="Entrega.jsp?user=" + idUser + "&list" + valores + "&boolean=borrarDatos";
		}else{
			alert("La operación se ha cancelado a petición del usuario");
			window.location="Entrega.jsp?user=" + idUser + "&list" + valores;
		}	
	...
	function CargarDatosAlumnos() {
		...
		if (confirmacion == true) {
			alert("Hecho. Se han borrado los datos de los alumnos");
			window.location="Entrega.jsp?user=" + idUser + "&list" + valores + "&boolean=cargarAlumnos";
		}else{
			alert("La operación se ha cancelado a petición del usuario");
			window.location="Entrega.jsp?user=" + idUser + "&list" + valores;
		}
	...
	function CargarDatosPracticas() {
		...
		if (confirmacion == true) {
			alert("Hecho. Se han borrado los datos de los alumnos");
			window.location="Entrega.jsp?user=" + idUser + "&list" + valores + "&boolean=cargarPracticas";
		}else{
			alert("La operación se ha cancelado a petición del usuario");
			window.location="Entrega.jsp?user=" + idUser + "&list" + valores;
		}	
...
<div id="content">
<div class="post">
<div class="title">Estadisticas de la Entrega</div>
...
<ul>
	<li>
	<h2>Estadisticas de Entrega</h2>
	<ul>
		<%List<String> ListaPractica = ObtenerDatos.ListaPracticas();
		for (String practica:ListaPractica){%>
			<li>
			<a href="<%=Configuracion.Jsp_EntregaP%>?user=<%=idUsuario%>&list=<%=idAlumnos%>&practica=<%=practica%>"><%out.println("Practica " + practica);%></a>
			</li>
		<%}%>
	</ul>
	</li>
