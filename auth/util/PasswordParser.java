...
/**
   ...
   Ofrece un método para obtener una tabla de identificadores-claves una vez termine la 
   inicialización del fichero.
...
public class PasswordParser extends DefaultHandler {
    ...
    /**
      Método que atiende al evento de inicio de un documento XML.
    */
    ...
    /**
       Método que atiende al evento de inicio de un elemento XML.
    */
    ...
    /**
      Método que atiende al evento de fin de un documento XML.
    */
    ...
    */
    ...
    /**
       Método que devuelve la tabla que ha sido obtenida al analizar el documento.
    */
	...
	*/
        ...
        /**
	   Devuelve información sobre la excepción que ha ocurrido.
         */
