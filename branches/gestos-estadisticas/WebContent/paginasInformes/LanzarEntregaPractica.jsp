...
<body>
    ...
    <div id="page">
		<div id="content">
		  <div class="post">
				<div class="title">Estadistica de las Entregas</div>
		...
		<ul>
			<li>
				...
				%>
						<li><a href="<%=Configuracion.Jsp_AlumnosP%>?user=<%=idUsuario%>&list=<%=idAlumnos%>&practica=<%=id_practica%>">
						<%
		...
		<ul>
			<li>
				...
				<ul><%
					for (String practica:ListaPractica){
				%>
						<li><a href="<%=Configuracion.Jsp_GrupoP%>?user=<%=idUsuario%>&list=<%=idAlumnos%>&practica=<%=id_practica%>"><%
							out.println("Practica "+ practica);
						%></a></li>
					<%
						}
