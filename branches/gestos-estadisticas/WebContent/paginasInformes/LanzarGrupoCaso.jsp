...
<script type="text/javascript">
	...
	function redirigir(idUser) {
		...
		window.location="Grupo.jsp?user=" + idUser +"&list=" + valores ;
 	}
	...
	function BorrarDatosAlumnos() {
		...
		if (confirmacion == true) {
				...
				window.location="Grupo.jsp?user=" + idUser + "&list" + valores + "&boolean=borrarAlumnos";
		}else{
	...
	function BorrarDatosPracticas() {
		...
		if (confirmacion == true) {
				alert("Hecho. Se han borrado los datos de los alumnos");
				window.location="Grupo.jsp?user=" + idUser + "&list" + valores + "&boolean=borrarPracticas";
		}else{
			alert("La operación se ha cancelado a petición del usuario");
			window.location="Grupo.jsp?user=" + idUser + "&list" + valores;
		}	
	...
	function BorrarDatosEstadisticas() {
		...
		if (confirmacion == true) {
			alert("Hecho. Se han borrado los datos de los alumnos");
			window.location="Grupo.jsp?user=" + idUser + "&list" + valores + "&boolean=borrarDatos";
		}else{
			alert("La operación se ha cancelado a petición del usuario");
			window.location="Grupo.jsp?user=" + idUser + "&list" + valores;
		}	
	...
	function CargarDatosAlumnos() {
		...
		if (confirmacion == true) {
			alert("Hecho. Se han borrado los datos de los alumnos");
			window.location="Grupo.jsp?user=" + idUser + "&list" + valores + "&boolean=cargarAlumnos";
		}else{
			alert("La operación se ha cancelado a petición del usuario");
			window.location="Grupo.jsp?user=" + idUser + "&list" + valores;
		}
	...
	function CargarDatosPracticas() {
		...
		if (confirmacion == true) {
			alert("Hecho. Se han borrado los datos de los alumnos");
			window.location="Grupo.jsp?user=" + idUser + "&list" + valores + "&boolean=cargarPracticas";
		}else{
			alert("La operación se ha cancelado a petición del usuario");
			window.location="Grupo.jsp?user=" + idUser + "&list" + valores;
		}	
...
<div class="entry">
	...
	<table>
		<tr><td></td></tr>
		<tr><td></td></tr>
		<tr><td><%=ComentariosGraficos.N_Informe_Caso_Grupo%></td></tr>
	</table>
	</div><!-- end #comment -->
</div><!-- end #entry -->
</div><!-- end #post -->
...
<ul>
	...
	<ul>
		...
		for (String test:ListaTest){%>
			<li><a href="<%=Configuracion.Jsp_GrupoT%>.jsp?user=<%=idUsuario%>&list=<%=idAlumnos%>&practica=<%=id_practica%>&test=<%=test%>"><%out.println("Test "+ test);%> </a></li>
		<%}%>
	</ul>
	</li>
</ul>
