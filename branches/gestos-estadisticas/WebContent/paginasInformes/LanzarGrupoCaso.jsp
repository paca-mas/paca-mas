...
%>
	...
	function redirigir(idUser) {
		...
		window.location="LanzarGrupoCaso.jsp?user="+idUser+"&list=" + valores + "&practica=" + idPrac + "&test=" + idTest;
 	}
	</script>
<%
	// Ruta
    ...
    <div id="page">
		...
		<ul>
			<li>
				...
				%>
						<li><a href="<%=Configuracion.Jsp_GrupoT%>.jsp?user=<%=idUsuario%>&list=<%=idAlumnos%>&practica=<%=id_practica%>&test=<%=test%>">
						<%
