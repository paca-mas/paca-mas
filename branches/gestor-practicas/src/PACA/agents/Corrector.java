...
public class Corrector extends Agent {
	 ...
	 * se ejecuta de manera c�clica hasta que el agente muere.
	 */
	...
	/**
	 * M�todo que configura el agente. Selecciona el lenguaje de contenido, 
	 * la ontolog�a que utiliza y aniade el comportamiento que se ejecutar�.
	 */
