...
public class InterfazJSP extends Interfaz {
	 ...
	 */
	public String doEntregaFinalRequest(HttpServletRequest request)
		throws IOException {
	...
	//================================================================================
	public String[] doObtieneContenidoRequest(HttpServletRequest request)
		throws IOException {
	...
	public class AutenticaRequestBeha extends OneShotBehaviour {
		...
		public void action() {
			HttpServletRequest param1 =
				(HttpServletRequest) test2.getParametro();
			String auxUsuario = param1.getParameter("user_id");
			String auxPass = param1.getParameter("password");
			addBehaviour(new EnviaAutenticaBehaviour(
				this.myAgent, test2, auxUsuario, auxPass));
		}
	}
	...
	public class PideTestRequestBeha extends OneShotBehaviour {
		...
		public void action() {
			HttpServletRequest param1 =
				(HttpServletRequest) tes2.getParametro();
